...
<ss:template name="#content:vilarity/object/program_node/session-panel"
    xmlns="http://www.w3.org/1999/xhtml"
    xmlns:ss="http://www.basicmatrix.com/schema/ss">
<div v-on:change="$root.OnSaveProgramNode(editProgramNode);">
      <p>
      ...
      <p>
        ...
        <input class="uk-input uk-text-small" title="Short Description" placeholder="Short Description" v-model="editProgramNode.description" />
      </p>
      <p>
      ...
      <p>
        ...
        <input class="uk-input uk-text-small" title="URL Link" placeholder="URL Link" v-model="editProgramNode.key" />
      </p>
      <p>
        ...
        <div style="display: flex; flex-direction: row; flex-basis: 100%; position: relative;">
          <ckeditor style="width: 100%; height: 100%;"
            ...
            v-on:input="function(event) { OnSaveProgramNode(editProgramNode,'instructionsContent',inputSaveDebounceDelay); }"
            v-on:change="function(event) { OnSaveProgramNode(editProgramNode,'instructionsContent',/*debounceDelay=*/ 0); }"
